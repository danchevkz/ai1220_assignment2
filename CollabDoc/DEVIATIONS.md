...
| 11 | Testing | Manual | Three-layer automated suite: pytest (backend, 76 tests), vitest + RTL (frontend unit, 138 tests), Playwright (8 E2E specs including two-browser-context CRDT) | A1 feedback docked us for having no automated tests; tests land with each feature | Improvement — covers Assignment 1 feedback item 4 and bonus #5. |
